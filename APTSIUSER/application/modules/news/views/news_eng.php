        ...
        <div id="content">
          ...
          <article class="post post-list post-type-text">
            <div class="post-heading">
              <div class="thumbnail">
                <a class="link" href="<?php echo base_url();?>dac/news/read/<?= $row->slug?>">
            ...
            <div class="post-content">
              ...
              <div class="content-right">
                <div class="title">
                  <h2><a href="<?php echo base_url();?>dac/news/read/<?= $row->slug?>"><?= $row->judul?></a></h2>
                  <p class="meta">
                ...
                <div class="text">
                  ...
                  <p> <a class="btn" href="<?php echo base_url();?>dac/news/read/<?= $row->slug?>">READ MORE</a></p>
                </div><!-- .text -->
              </div><!-- .content-right -->
            </div><!-- .post-content -->
          </article><!-- /posts -->
