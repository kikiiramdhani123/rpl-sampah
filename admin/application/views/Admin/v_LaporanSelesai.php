    ...
    <tr><th>No</th>
		...
		<tbody>
			...
			<tr class="odd gradeX">
				...
				<td><a href="<?php echo site_url();?>Admin/hapuslaporan/<?php echo $new->id_laporan?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
		<?php $no=$no+1; } ?>
		</tbody>
	</table>
    </div>
