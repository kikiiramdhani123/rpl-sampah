...
class Googlemaps {
	...
	var $apiKey						= ' AIzaSyDQCgdhsSaENapkzU0y39f8WTDpFlZM71E '; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
