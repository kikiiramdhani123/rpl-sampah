          ...
          <article class="post post-list post-type-text">
            <div class="post-heading">
              <div class="thumbnail">
                <a class="link" href="<?php echo base_url();?>news/read/<?= $row->id_berita?>">
                  ...
                  <img src="<?php echo base_url(); ?>assets/images/berita/<?= $row->gambar?>" alt="img" width="850" height="480">
                </a>
              </div><!-- .thumbnail -->
            </div><!-- .post-heading -->
            <div class="post-content">
              ...
              <div class="content-right">
                <div class="title">
                  <h2><a href="<?php echo base_url();?>news/read/<?= $row->id_berita?>"><?= $row->judul?></a></h2>
                ...
                <div class="text">
                  <p><?= $row->deskripsi?></p>
                  <p> <a class="btn" href="<?php echo base_url();?>news/read/<?= $row->id_berita?>">READ MORE</a></p>
                </div><!-- .text -->
              </div><!-- .content-right -->
            </div><!-- .post-content -->
          </article><!-- /posts -->
