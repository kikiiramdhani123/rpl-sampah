...
<div class="col-lg-10">
<h2> Laporan Proses</h2>
<ol class="breadcrumb">
<li>Home</li>
<li class="active">Laporan Proses</li>
</ol>
</div>
...
<br>
    ...
    <tbody>
			...
			<tr class="odd gradeX">
				...
				<td><a href="<?php echo site_url();?>Admin/makelaporanselesai/<?php echo $new->id_laporan ?>" class="btn btn-primary">Selesai</a> 
